    ...
    return (
        <div className='bg-gray-200 dark:bg-zinc-900'>
            <div className='p-5 max-w-7xl mx-auto bg-white rounded-lg'>
                <h1 className='uppercase text-center text-3xl lg:text-5xl font-bold'>TERMS & Conditions</h1>
                <div className='space-y-3'>
                    <div className='space-y-2'>
                        ...
                        <p className='border-l-2 border-zinc-900 dark:border-zinc-100 p-2'>
                            By accessing this web site, you are agreeing to be bound by these web site Terms and Conditions of Use, all applicable laws and regulations, and agree that you are responsible for compliance with any applicable local laws. If you do not agree with any of these terms, you are prohibited from using or accessing this site. The materials contained in this web site are protected by applicable copyright and trade mark law. You agree and accept the terms to receive the important notification and promotional offers via SMS, RCS, WhatsApp, Email and other channels.
                        </p>
                    </div>
                    <div className='space-y-2'>
                        <h3 className='text-3xl'>
                        ...
                        <ul className='list-decimal pl-8 space-y-2'>
                            <li className='border-l-2 border-zinc-900 dark:border-zinc-100 p-1'>
