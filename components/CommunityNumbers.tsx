...
function CommunityNumbers({ }: Props) {
    return (
        <div className='max-w-3xl mx-auto p-5'>
            <div className='lg:py-10 flex flex-col md:flex-row items-center justify-between bg-white group hover:shadow-lg transition transform duration-300 ease-out'>
                <div className='max-w-xs text-center px-12 py-8'>
